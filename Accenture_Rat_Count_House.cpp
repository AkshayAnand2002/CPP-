...
‘r’ represents the number of rats present in an area, ‘unit’ is the amount of food each rat consumes and each ith element of array 
...
= 7 * 2 = 14.
The amount of food in 1st few houses i.e. till 4th house = 2+8+3+5 = 18. Since, amount of food in 1st 4 houses is sufficient for all the rats. Thus, output is 4.
*/
#include<bits/stdc++.h>
using namespace std;
